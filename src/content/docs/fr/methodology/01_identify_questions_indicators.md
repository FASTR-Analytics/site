---
title: "Identifier les questions et les indicateurs"
---
...
Bien que des méthodes statistiques telles que l'imputation puissent être utilisées pour traiter les données incomplètes, ces méthodes requièrent des hypothèses sur les valeurs manquantes. De plus amples détails sont fournis dans [Ajustement de la qualité des données](05_data_quality_adjustment).
...
![Exemple FASTR Nigeria 1](/methodology/resources/screenshots/country_examples/nigeria_example_1.png)

</div>
<div style="flex: 1;">

![Exemple FASTR Nigeria 2](/methodology/resources/screenshots/country_examples/nigeria_example_2.png)
...
![Suivi de la vaccination en Guinée h:440](/methodology/resources/screenshots/country_examples/guinea_immunization.jpeg)
<!-- /SLIDE -->
...
![Suivi FASTR Éthiopie h:440](/methodology/resources/screenshots/country_examples/ethiopia_example.png)
<!-- /SLIDE -->
...
![Liste de contrôle de préparation des données h:280](/methodology/resources/screenshots/data_prep_checklist.png)
