---
title: "FASTR RMNCAH-N service use monitoring: Methodology documentation"
---
...
- [**Identify questions & indicators**](01_identify_questions_indicators) - Defining priority questions and selecting core indicators for FASTR implementation
- [**Data extraction**](02_data_extraction) - Extracting and preparing HMIS data from DHIS2 for analysis
- [**The FASTR data analytics platform**](03_fastr_analytics_platform) - Using the platform for automated analysis and visualization

### Analytics modules (FASTR platform)

The FASTR analytics platform includes five automated modules:

- [**Data quality assessment**](04_data_quality_assessment) - Module 1 in the platform. Assessment of HMIS data quality through completeness, outlier detection, and consistency metrics
- [**Data quality adjustment**](05_data_quality_adjustment) - Module 2 in the platform. Techniques for improving data accuracy by adjusting for outliers and incomplete reporting
